                              ...
                              GstBuffer *buffer)
{
	...
	/*gamma correction:*/
	{
		...
		{
			newGammaValue = 1 + 1.0 * (0.5 - measured_brightness);
		}
    ...
    /*update final image*/
    mat(cv::Rect(0,pr_shmp->dest_image_height+1,pr_shmp->dest_image_width,pr_shmp->dest_image_width-pr_shmp->dest_image_height)).setTo(0); //set 640*280 portion of 640*640(model input)to 0
